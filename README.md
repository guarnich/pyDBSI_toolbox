...
git clone https://github.com/your-repo/dbsi-toolbox.git
cd dbsi-toolbox
...
# Results shape: (X, Y, Z, 7)
# Channels: [fiber_frac, restricted, hindered, water, AD, RD, FA]
```
...
| Channel | Name | Description | Interpretation |
|---------|------|-------------|----------------|
| 0 | Fiber Fraction | Apparent axonal density | ↓ = axon loss |
| 1 | Restricted Fraction | Cellularity (ADC ≤ 0.3 µm²/ms) | ↑ = inflammation |
| 2 | Hindered Fraction | Edema/tissue loss (0.3 < ADC ≤ 3.0) | ↑ = edema |
| 3 | Water Fraction | CSF contamination (ADC > 3.0) | ↑ = tissue loss |
